...
def get_pipeline(
    ...
    default_bucket=None,
    input_data_url=None,
    bucket_prefix="hurtos-med/randomforest",
    model_package_group_name="hurtos-med-model-group",
    pipeline_name="hurtos-med-pipeline",
    base_job_prefix="hurtos-med-pipeline",
    ...
    step_fail = FailStep(
        ...
        error_message=Join(on=" ", values=["Execution failed due to r2 Score >", test_score_threshold_param]),
    )
